...
<div className="flex justify-center my-6">
  <img src="/blogs/ci-cd.png" alt="CI-CD" className="rounded-xl shadow-md w-2/3" />
</div>

## 🚀 Deploying Your App to EC2 with CI/CD

Let’s set up a **real-world CI/CD pipeline**:  
Every time you push to `main` or `merge` to main, GitHub Actions will automatically deploy your project to an **AWS EC2 instance**.
...
✅ Done! Now every time you push or merge to **main**:
