---
title: Skaya AI Component Generator 
description: Accelerate your UI development with Skaya's AI Component Generator. Learn how to use the `skaya create component` command to instantly scaffold React components with TypeScript, Storybook stories, and unit tests.
keywords:
  - Skaya
  - component generator
  - AI
