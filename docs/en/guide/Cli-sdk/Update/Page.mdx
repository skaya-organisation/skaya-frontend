---
sidebar_position: 2
title: Skaya AI Page Updater | Refactor React Pages with AI
description: Evolve your application's UI with Skaya's AI Page Updater. Learn to use the `skaya update page` command to refactor entire pages by adding new components and API integrations via AI prompts.
keywords:
  - Skaya
  - page updater
  - AI page refactoring
...
- [Basic Skaya page creation](/guide/Cli-sdk/Create/Component)
